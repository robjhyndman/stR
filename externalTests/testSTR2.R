...
seasonData = rep(1, n)
trend = list(data = trendData, times = times, seasons = trendSeasons, timeKnots = timeKnots, seasonalStructure = trendSeasonalStructure, lambdas = c(1,0,0))
season = list(data = seasonData, times = times, seasons = seasons, timeKnots = timeKnots, seasonalStructure = seasonalStructure, lambdas = c(10,0,10))
predictors = list(trend, season)
...
trendData = rep(1, n)
seasonData = rep(1, n)
trend = list(data = trendData, times = times, seasons = trendSeasons, timeKnots = trendTimeKnots, seasonalStructure = trendSeasonalStructure, lambdas = c(0,0,0))
...
trendData = rep(1, n)
seasonData = rep(1, n)
trend = list(data = trendData, times = times, seasons = trendSeasons, timeKnots = trendTimeKnots, seasonalStructure = trendSeasonalStructure, lambdas = c(10,0,0))
...
trend = list(name = "Trend", data = trendData, times = times, seasons = trendSeasons,
             timeKnots = trendTimeKnots, seasonalStructure = trendSeasonalStructure, lambdas = c(0.5,0,0))
season = list(name = "Yearly seasonality", data = seasonData, times = times, seasons = seasons,
...
seasonalStructureWeeks = list(segments = list(c(0, 169*5)), sKnots = sKnotsWeeks)
...
seasonDays = list(data = seasonData, times = times, seasons = seasonsDays,
                  timeKnots = seq(min(times), max(times), length.out=25),
                  seasonalStructure = seasonalStructureDays, lambdas = c(0, 11, 30))
...
data$Weekday = as.integer(factor(weekdays(data[,"Date"], abbreviate=T), levels=c("Mon","Tue","Wed","Thu","Fri","Sat","Sun")))
...
WorkingDay48Ago = c(rep(NA, 48), data$WorkingDay[-((length(data$WorkingDay)-47):length(data$WorkingDay))])
...
Data2 = data[, c("OperationalLessIndustrial", "TempM", "TempF", "Time", "DailySeasonality", "WeeklySeasonality", "WDSeasonality")]
colnames(Data2) <- c("Demand", "TempM", "TempF", "Time", "DailySeasonality", "WeeklySeasonality", "WDSeasonality")

myData = Data2[481:6000,]

TrendSeasonalStructure = list(segments = list(c(0,1)), sKnots = list(c(1,0)))
DailySeasonalStructure = list(segments = list(c(0,48)), sKnots = c(as.list(1:47), list(c(48,0))))
WeeklySeasonalStructure = list(segments = list(c(0,336)), sKnots = c(as.list(1:335), list(c(336,0))))
WeeklySeasonalStructure4 = list(segments = list(c(0,336)), sKnots = c(as.list(seq(4,332,4)), list(c(336,0))))
WeeklySeasonalStructure2 = list(segments = list(c(0,336)), sKnots = c(as.list(seq(2,334,2)), list(c(336,0))))
...
TrendTimeKnots = seq(from = stR:::first(Times), to = stR:::last(Times), length.out = 116)
SeasonTimeKnots = seq(from = stR:::first(Times), to = stR:::last(Times), length.out = 24)

TrendData = rep(1, length(Times))
SeasonData = rep(1, length(Times))

Trend = list(name = "Trend", data = TrendData, times = Times, seasons = TrendSeasons, timeKnots = TrendTimeKnots, seasonalStructure = TrendSeasonalStructure, lambdas = c(100,0,0))

WDSeason = list(name = "Dayly seas", data = SeasonData, times = Times, seasons = WDSeasons, timeKnots = SeasonTimeKnots, seasonalStructure = WDSeasonalStructure, lambdas = c(3,0,50))

TrendTempM = list(name = "Trend temp Mel", data = TempM, times = Times, seasons = TrendSeasons, timeKnots = TrendTimeKnots, seasonalStructure = TrendSeasonalStructure, lambdas = c(10,0,0))
TrendTempM2 = list(name = "Trend temp Mel^2", data = TempM2, times = Times, seasons = TrendSeasons, timeKnots = TrendTimeKnots, seasonalStructure = TrendSeasonalStructure, lambdas = c(10,0,0))
