...
In this section we continue working with the `co2` dataset. Since it is of class `ts`, we can use the `AutoSTR` function, which automates the decomposition options:
