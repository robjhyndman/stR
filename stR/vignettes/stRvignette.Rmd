...
To check meaningfulness of the forecast it is advisable to plot beta coefficients of the decomposition. If the coefficients are too "wiggly" the forecasts can be unstable.
...
2. For testing and exploration purposes it is recommended to avoid calculation of the confidence/forecasting intervals. Such calculation currently involves inversion of a big matrix and can take long time.

3. To monitor progress of the parameters' estimation it is recommended to set parameter trace to TRUE when function STR is called.
