...
stR implements method STR, where STR stands for Seasonal-Trend decomposition by Regression and capital R emphasizes R, the name of a popular statistical software. The whole name is also reminiscent of STL, the method which inspired me to introduce STR.
...
A short answer is that
  ...
  2. the method has well studied theoretical background (OLS and quantile regression).
