...
* <code>reltol = 0.001</code> -- this parameter is passed directly to <code>optim</code> function, it controls how well (and long) the model parameters will be optimized
