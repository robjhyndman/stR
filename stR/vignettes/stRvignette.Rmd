...
A short answer is that
  ...
  1. the new method has a richer set of features (and allows users to implement even more features); and
...
In this section we continue working with the `co2` dataset. Since it is of class `ts`, we can use the `AutoSTR` function:
