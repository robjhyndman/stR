...
On the other hand if we use Robust STR decomposition, the result becomes more meaningful. The outliers appear in residuals and trend and seasonal components are similar to waht they were before we added the outliers: 
```{r, fig.show='hold', fig.width = 7, fig.height = 3, cache=TRUE, autodep=FALSE, echo=TRUE, warning=FALSE, results='hide'}
